...
<div class="form_menubox">
					  <div class="inputmain"><div class="user_form_text">Extra Loyalty:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					     <s:textfield name="extraLoyalty"  id="extraLoyalty" value="%{extraLoyalty}" readonly="true" cssClass="form_menu_inputtext" placeholder="Enter Data" cssStyle="margin:0px 0px 10px 0px"/>
					     </div>
					  </div>
</div>
