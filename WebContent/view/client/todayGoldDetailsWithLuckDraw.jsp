...
<div class="form_menubox">
					  <div class="inputmain" id="cashInhnd"><div class="user_form_text">Gold Of Rs.:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					     <s:textfield name="goldOfrs"  id="goldOfrs" value="%{goldOfrs}" cssClass="form_menu_inputtext" readonly="true" placeholder="Enter Cash In Hand" cssStyle="margin:0px 0px 10px 0px"/>
					     </div>
					  </div>
					  <div class="inputmain" id="clcultedDIv" style="display: none;"><div class="user_form_text1">Gold in GM's:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					     <s:textfield name="goldingm"  id="goldingm" cssClass="form_menu_inputtext" cssStyle="margin:0px 0px 10px 0px"/>
					     </div>
					  </div>
