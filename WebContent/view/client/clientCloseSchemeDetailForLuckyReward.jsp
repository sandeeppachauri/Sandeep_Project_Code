...
<div class="form_menubox">
					  <div class="inputmain"><div class="user_form_text">Remain Insta:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					     <s:textfield name="remainInsta"  id="remainInsta" value="%{remainInsta}" readonly="true" cssClass="form_menu_inputtext" placeholder="Enter Data" cssStyle="margin:0px 0px 10px 0px"/>
					     </div>
					  </div>
					  <div class="inputmain"><div class="user_form_text1">Future Deposit:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					     <s:textfield name="futureDeposit"  id="futureDeposit" value="%{futureDeposit}" readonly="true" cssClass="form_menu_inputtext" placeholder="Enter Data" cssStyle="margin:0px 0px 10px 0px"/>
					     </div>
					  </div>
...
<div class="form_menubox">
					  <div class="inputmain"><div class="user_form_text">Return Type:</div>
					     ...
					     <s:select id="rewardType" name="rewardType" 
                              list="{'Cash','Jwellery','Adjustment','Scratch Card'}"
...
<div class="form_menubox">
					  <div class="inputmain"><div class="user_form_text">Reward Value:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					     <s:textfield name="rewardCash"  id="rewardCash" cssClass="form_menu_inputtext" placeholder="Enter Reward In Hand" cssStyle="margin:0px 0px 10px 0px"/>
					     </div>
					  </div>
</div>
<font color="red" size="2"><b>*Note:</b>In case of Scratch Card lucky draw please fill winning item in Reward Value/Cash in hand in Reward Value.</font>
</div>
