...
<div class="page_title"><h1>Client Scheme >> Mapping</h1>
<span class="needed_block">= indicates mandatory fields</span>
</div>
<div class="container_block"><div style=" float:left; padding:20px 5%; width:90%;">
<sj:accordion id="accordion" autoHeight="false">
<sj:accordionItem title="Client Scheme >> Mapping" id="oneId">  
<div class="form_inner" id="form_reg">
<div class="page_form">
		<s:form id="formone" name="formone" namespace="/view/client" action="clientSchemeMapping" theme="simple"  method="post">
	                   ...
	                   <div class="inputmain"><div class="user_form_text">Client:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					      <s:select id="clientName" name="clientName" 
                              list="#{'1':'Sandeep Client','2':'Sachin Client','3':'Avinash Client'}"
					  ...
					  <div class="inputmain"><div class="user_form_text1">Scheme Name:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					      <s:select id="schemeName" name="schemeName" 
                              list="#{'1':'1000 Per Month','2':'500 Incrmnt Month','3':'3250 Per Month','4':'2000 Per Month','5':'Beti ki gullak','6':'Daily'}"
			  ...
			  <div class="form_menubox">
					  ...
					  <div class="inputmain"><div class="user_form_text">Scheme Ammount:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					    <s:select id="schemeSubType" name="schemeSubType" 
                              list="#{'1':'1000 Per Month','2':'500 Incrmnt Month','3':'3250 Per Month','4':'2000 Per Month','5':'Beti ki gullak','6':'Daily'}"
                              headerKey="-1" headerValue="--Select Scheme--" cssClass="form_menu_inputselect"
                              >
                 			 </s:select>
					     <div id="errorschemeSubType" class="errordiv"></div>
					     </div>
					  </div>
             	</div>
