...
$.subscribe('validate1', function(event,data)
        {
		    ...
		    {
				clearAllErroDiv();
				errorclientName.innerHTML="Error: Enter Your Name";
		    ...
		    {
				clearAllErroDiv();
				errorclientMob.innerHTML="Error: Enter Your MobileNo";
            	event.originalEvent.options.submit = false;
            	return false;
		    }
		    ...
		    {
				clearAllErroDiv();
				errorclientAddress.innerHTML="Error: Enter Your Address";
            	event.originalEvent.options.submit = false;
            	return false;
		    }
...
<body>
<div class="page_title"><h1>My Information</h1>
<span class="needed_block" style="top:168px;">= indicates mandatory fields</span>
</div>
<div class="container_block"><div style=" float:left; padding:20px 5%; width:90%;">
<sj:accordion id="accordion" autoHeight="false">
<sj:accordionItem title="My Information" id="oneId">  
<div class="form_inner" id="form_reg">
<div class="page_form">
		<s:form id="formone" name="formone" namespace="/view/clientlogin" action="updateClientInfo" theme="simple"  method="post">
                 ...
                 <div class="form_menubox">
					  ...
					  <div class="inputmain"><div class="user_form_text1">Mobile No:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					     <s:textfield name="clientMob"  id="clientMob" cssClass="form_menu_inputtext" placeholder="Enter Data" cssStyle="margin:0px 0px 10px 0px"/>
             	...
             	<div class="form_menubox">
					  ...
					  <div class="inputmain"><div class="user_form_text1">D.O.J:</div>
					     <div class="user_form_input inputarea"><span class="needed"></span>
					     <sj:datepicker name="doj_date" id="doj_date" changeMonth="true" disabled="true" readonly="true" changeYear="true" yearRange="1970:2020" showOn="focus" displayFormat="dd-mm-yy" 
