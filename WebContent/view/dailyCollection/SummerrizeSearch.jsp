...
function searchReport()
{
	...
	var dataObj={"scheme":scheme,"dateTo":dateTo};
	$.ajax({
		 type : "post",
		    url : "<%=request.getContextPath()%>/view/common/CollectionReportSearch.action",
		    data: dataObj,
...
<div class="page_title"><h1> Collection >> Report View</h1>
</div>
