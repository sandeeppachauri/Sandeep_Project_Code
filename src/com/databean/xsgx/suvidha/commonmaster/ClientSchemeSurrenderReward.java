...
@Entity
@Table(name = "schemesurrenderedcompletereward")
@Proxy(lazy = false)
public class ClientSchemeSurrenderReward {
	...
	@Column(name = "rewardCash")
	private String rewardCash;
	@Column(name = "goldingmPrcs")
	private String goldIngmPrcs;
