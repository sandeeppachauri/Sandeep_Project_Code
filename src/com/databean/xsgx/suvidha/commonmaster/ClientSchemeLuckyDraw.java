...
@Entity
@Table(name = "clientschemeluckydraw")
@Proxy(lazy = false)
public class ClientSchemeLuckyDraw {
	...
	@Column(name = "remainInsta")
	private String remainInsta;

	@Column(name = "futureDeposit")
	...
	@Column(name = "goldOfrs")
	private String goldOfrs;
